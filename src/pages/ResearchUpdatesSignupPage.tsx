...
const ResearchUpdatesSignupPage = () => {
        ...
        <main className="flex-1 flex items-center justify-center py-20">
          <div className="max-w-md mx-auto text-center px-4">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Thank you for subscribing to our Research Updates. You'll receive
              comprehensive research reports and strategic insights directly in
              your inbox.
            </p>
        ...
        <div className="max-w-md mx-auto px-4">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Get comprehensive research reports and strategic deep analysis
          ...
          <div className="mt-8 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li className="flex items-start">
                <div className="w-1.5 h-1.5 bg-primary-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                Strategic deep analysis and insights
              </li>
              <li className="flex items-start">
                <div className="w-1.5 h-1.5 bg-primary-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
...
export default ResearchUpdatesSignupPage;
