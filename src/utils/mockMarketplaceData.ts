...
export const fetchKnowledgeHubItems = async () => {
  try {
    console.log(
      "🔍 [Marketplace] Starting to fetch knowledge hub items from database...",
    );
    ...
    if (mediaItems.data && mediaItems.data.length > 0) {
      ...
      console.log(
        "All IDs from DB:",
        mediaItems.data.map((i: any) => i.id),
      );
      console.log(
        "All Types from DB:",
        mediaItems.data.map((i: any) => i.type),
      );
    }
    console.groupEnd();
...
export const getKnowledgeHubItems = async () => {
  console.log(
    "🚀 [Marketplace] getKnowledgeHubItems called - starting data fetch...",
  );
  ...
  try {
    ...
    console.log("🎯 [Marketplace] Final real items list ready:", {
      ...
      top3: realItems
        .slice(0, 3)
        .map((i) => ({ id: i.id, title: i.title, date: i.date })),
    });
...
export const mockKnowledgeHubItems = [
  {
    id: "6xd-digital-perspectives-book",
    title:
      "6xD - The Six Digital Perspectives: A Comprehensive Framework for Digital Transformation",
    description:
      "Dr. Stéphane Niango's groundbreaking blueprint for building Digital Cognitive Organizations in the Age of AI. This comprehensive guide provides the definitive framework for navigating digital disruption through six critical perspectives.",
    mediaType: "Books",
    filterType: "Books",
    ...
    popularity: "Featured",
    provider: {
      name: "DigitalQatalyst Publishing",
      logoUrl: "https://placehold.co/400x400/FF6B4D/white?text=DQ",
      description:
        "Leading publisher of digital transformation literature and strategic frameworks.",
    },
    tags: [
      "6xD Framework",
    ...
    imageUrl: "/book cover/Untitled_design__5_-removebg-preview.png",
    date: "March 2026",
    downloadCount: 2847,
    fileSize: "15.2 MB",
    readTime: "8 hours",
    author: {
      name: "Dr. Stéphane Niango",
      title: "Architect of the Digital Cognitive Organization",
      avatar: "/images/Stephane_Avatar.png",
    },
    detailsUrl: "/books",
    bookUrl: "/books",
  ...
  },
  {
    ...
    title: "Digital Transformation Playbook: A Leader's Guide to Success",
    description:
      "A comprehensive guide to leading successful digital transformation initiatives in modern organizations. Packed with practical frameworks, real-world case studies, and actionable strategies.",
    mediaType: "Books",
    filterType: "Books",
    businessStage: "Growth",
    domain: "Leadership",
    format: "Strategic Blueprints",
    popularity: "Popular",
    provider: {
      name: "DigitalQatalyst Publishing",
      logoUrl: "https://placehold.co/400x400/FF6B4D/white?text=DQ",
    ...
    detailsUrl: "/books/digital-transformation-playbook",
    bookUrl: "/books/digital-transformation-playbook",
    price: "$24.99",
    format: "Digital & Print",
    pages: "256 pages",
  ...
  {
    id: "ai-leadership-digital-age",
    title:
      "AI Leadership in the Digital Age: Strategic Insights for Competitive Advantage",
    description:
      "Strategic insights on leveraging artificial intelligence for competitive advantage and organizational growth. Learn how to build AI-driven organizations that thrive in the digital economy.",
    mediaType: "Books",
    filterType: "Books",
    businessStage: "Scale",
    ...
    author: {
      name: "Michael Chen",
      title: "VP Digital Strategy, Global Corp",
      avatar: "/images/Michael_Avatar.png",
    },
    detailsUrl: "/books/ai-leadership-digital-age",
    bookUrl: "/books/ai-leadership-digital-age",
    price: "$32.99",
    format: "Digital & Print",
    pages: "298 pages",
