...
const BooksLandingPage = () => {
  ...
  const domains = [
    { id: "D1", label: "Digital Economy Essentials", accentColor: "text-blue-600", dotColor: "bg-blue-600", bg: "bg-white", books: [
      { title: "The Second Machine Age", author: "Erik Brynjolfsson & Andrew McAfee", description: "A foundational look at how digital technologies reshape the global economy.", tags: ["Digital Economy", "Foundational"], score: "9.1", img: "https://images.unsplash.com//Digital%20Economy%20Essential/imgi_2_cover_the-age-of-surveillance-capitalism_360px_1747144484.jpg&q=80" },
      { title: "Digital Empires", author: "Anu Bradford", description: "Analyzes the global battle to regulate technology and its economic implications.", tags: ["Policy", "Regulation"], score: "8.7", img: "https://images.unsplash.com//Digital%20Economy%20Essential/imgi_28_cover_the-new-digital-age_360px_1747177735.webp&q=80" },
      { title: "The Age of Surveillance Capitalism", author: "Shoshana Zuboff", description: "Explores the new economic order where human experience is raw material for data.", tags: ["Data Economy", "Society"], score: "9.3", img: "https://images.unsplash.com//Digital%20Economy%20Essential/imgi_29_cover_competing-in-the-age-of-ai_360px_1747137011.webp&q=80" },
    ]},
    { id: "D2", label: "Building Digital Cognitive Organizations", accentColor: "text-purple-600", dotColor: "bg-purple-600", bg: "bg-gray-50", books: [
      { title: "Cognitive Kin", author: "Christophe Kolb & Jan Rosen (2026)", description: "Explores how agentic AI becomes a digital workforce that reasons and pursues goals.", tags: ["AI", "DCO", "2026"], score: "9.0", img: "https://images.unsplash.com//building%20digital%20cognitive%20organizations/imgi_3_default.png" },
      { title: "Autonomous", author: "Vala Afshar & Henry King (2025)", description: "A roadmap for building businesses that use digital labor to scale.", tags: ["AI-First", "Strategy", "2025"], score: "8.8", img: "https://images.unsplash.com//building%20digital%20cognitive%20organizations/imgi_4_default.jpg" },
      { title: "Cognitive Organizations", author: "Kenneth Correa", description: "Focuses on leveraging Generative AI and intelligent agents for automation.", tags: ["GenAI", "Automation"], score: "8.6", img: "https://images.unsplash.com//building%20digital%20cognitive%20organizations/imgi_5_default.jpg" },
    ]},
