...
const BooksLandingPage = () => {
  ...
  const domains = [
    { id: "D1", label: "Digital Economy Essentials", accentColor: "text-blue-600", dotColor: "bg-blue-600", bg: "bg-white", books: [
      { title: "The Second Machine Age", author: "Erik Brynjolfsson & Andrew McAfee", description: "A foundational look at how digital technologies reshape the global economy.", tags: ["Digital Economy", "Foundational"], score: "9.1", img: "https://images.unsplash.com//Digital Economy Essential/imgi_2_cover_the-age-of-surveillance-capitalism_360px_1747144484.jpg&q=80" },
      { title: "Digital Empires", author: "Anu Bradford", description: "Analyzes the global battle to regulate technology and its economic implications.", tags: ["Policy", "Regulation"], score: "8.7", img: "https://images.unsplash.com//Digital Economy Essential/imgi_28_cover_the-new-digital-age_360px_1747177735.webp&q=80" },
      { title: "The Age of Surveillance Capitalism", author: "Shoshana Zuboff", description: "Explores the new economic order where human experience is raw material for data.", tags: ["Data Economy", "Society"], score: "9.3", img: "https://images.unsplash.com//Digital Economy Essential/imgi_29_cover_competing-in-the-age-of-ai_360px_1747137011.webp&q=80" },
    ]},
