...
const BooksLandingPage = () => {
  ...
  const domains = [
    { id: "D1", label: "Digital Economy Essentials", accentColor: "text-blue-600", dotColor: "bg-blue-600", bg: "bg-white", books: [
      ...
      { title: "The Age of Surveillance Capitalism", author: "Shoshana Zuboff", description: "Explores the new economic order where human experience is raw material for data.", tags: ["Data Economy", "Society"], score: "9.3", img: "/digital-economy-essential/imgi_6_cover_the-new-geography-of-jobs_360px_1747148116.jpg" },
    ]},
    { id: "D2", label: "Building Digital Cognitive Organizations", accentColor: "text-purple-600", dotColor: "bg-purple-600", bg: "bg-gray-50", books: [
      ...
      { title: "Autonomous", author: "Vala Afshar & Henry King (2025)", description: "A roadmap for building businesses that use digital labor to scale.", tags: ["AI-First", "Strategy", "2025"], score: "8.8", img: "/building-digital-cognitive-organizations/imgi_7_default.jpg" },
      { title: "Cognitive Organizations", author: "Kenneth Correa", description: "Focuses on leveraging Generative AI and intelligent agents for automation.", tags: ["GenAI", "Automation"], score: "8.6", img: "/building-digital-cognitive-organizations/imgi_10_default.jpg" },
    ]},
    { id: "D3", label: "AI and Intelligent Enterprise Leadership", accentColor: "text-orange-600", dotColor: "bg-orange-600", bg: "bg-white", books: [
      { title: "Co-Intelligence", author: "Prof. Ethan Mollick", description: "A practical guide to human-AI collaboration for organizational development.", tags: ["AI", "Leadership", "Practical"], score: "9.2", img: "/Ai%20books/imgi_53_image-2-213x300.png" },
      { title: "The Coming Wave", author: "Mustafa Suleyman", description: "Addresses the containment problem and maintaining control over powerful tech.", tags: ["AI Risk", "Governance"], score: "9.0", img: "/Ai%20books/imgi_55_image-3-254x300.png" },
      { title: "Responsible Artificial Intelligence", author: "Virginia Dignum", description: "Essential for leaders navigating the ethical implications and governance of AI.", tags: ["AI Ethics", "Governance"], score: "8.9", img: "/Ai%20books/imgi_56_image-4.png" },
    ]},
    { id: "D4", label: "Platform Business and Digital Business Platform Strategy", accentColor: "text-green-600", dotColor: "bg-green-600", bg: "bg-gray-50", books: [
      { title: "Platform Revolution", author: "Parker, Van Alstyne & Choudary", description: "The foundational text on how networked markets transform business.", tags: ["Platforms", "Strategy", "Foundational"], score: "9.4", img: "/DBP/imgi_106_61DnUeDO1aL._SL1057_.jpg" },
      { title: "Platform Business Models", author: "R. Srinivasan (2025)", description: "A strategic guide to designing and operating modern platform firms.", tags: ["Platforms", "Business Models", "2025"], score: "8.8", img: "/DBP/imgi_13_default.jpg" },
    ...
    { id: "D7", label: "Organizational Design for the Digital Era", accentColor: "text-indigo-600", dotColor: "bg-indigo-600", bg: "bg-white", books: [
      ...
      { title: "The Phoenix and the Unicorn", author: "Peter Hinssen", description: "Offers a roadmap for corporate innovation and cultural renewal.", tags: ["Innovation", "Culture"], score: "8.7", img: "/Ai%20books/imgi_55_image-3-254x300.png" },
    ]},
